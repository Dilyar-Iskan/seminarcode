...
date_array=('2016-07-04' '2016-10-31' '2016-06-06' '2016-06-22' '2016-09-13' '2016-08-29' '2016-10-25' '2016-02-01' '2016-02-23' '2016-09-08')


for alpha in "${threshold[@]}"; do
	for date in "${date_array[@]}"; do
		python suggested_main.py --alpha $alpha --beta $alpha --test_path "./sample_data/real_Dilyar/tests/modi_assignment_filtered_test_$date.csv" --date $date --mode 'real' --exp_name 'exp_3_Dilyar_test'
	done;
done;